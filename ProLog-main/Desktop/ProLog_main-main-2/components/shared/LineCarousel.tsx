...
import { GestureResponderEvent, PanResponder, PanResponderGestureState, ScrollView, StyleSheet, Text, TouchableOpacity, View } from 'react-native';
...
export const LineCarousel: React.FC<LineCarouselProps> = ({
  ...
  return (
    <View style={styles.container}>
      <View style={styles.lineRow} {...panResponder.panHandlers}>
